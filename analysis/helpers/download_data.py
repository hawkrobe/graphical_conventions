...
if __name__ == "__main__":
  ...
  if not os.path.exists(os.path.join(path_to_data,'refgame1.2')):
    os.makedirs(os.path.join(path_to_data,'refgame1.2'))
    os.makedirs(os.path.join(path_to_data,'refgame2.0'))
  ...
  experimentList = ['refgame1.2/', 'refgame2.0/']
  ## get features from each experiment
  for experiment in experimentList:
    r = list(b.objects.filter(Prefix=experiment))
