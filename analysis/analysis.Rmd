...
version = '2.0'
prefix = here(paste0('data/experiment/', ifelse(version == '1.2', 'refgame1.2/graphical_conventions', 'refgame2.0/graphical_conventions')))
...
d.recog %>% 
  ...
  lmer(bis_relative ~ version * repetition + (1 + version * repetition | orig_gameID), 
       data = .) %>%
  summary()
```
...
ggsave('../../graphical_conventions_latex/nhb2020/figures/diagnosticity_change.pdf',
       width = 4, height = 4)
```
