...
ggsave(paste0(tmpprefix, 'refgame_BIS_timeseries', version, '.pdf'), width=14, height = 10, units='cm')
```
...
Double-check normalizing just within pre-post (balanced)
...
lmer(sim ~ poly(rep1, 2) + (1 + poly(rep1, 1)  | gameID), 
